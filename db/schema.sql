...
CREATE TABLE IF NOT EXISTS `oauth_states` (
    ...
    `app_key`              VARCHAR(255)  NULL     DEFAULT NULL              COMMENT 'Per-connection app key (populated by GAP 1)',
    `app_secret`           VARCHAR(255)  NULL     DEFAULT NULL              COMMENT 'Per-connection app secret (populated by GAP 1)',
