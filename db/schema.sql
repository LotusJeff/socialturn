...
CREATE TABLE IF NOT EXISTS `connected_platforms` (
    ...
    `app_key`             VARCHAR(255)   NULL     DEFAULT NULL              COMMENT 'Per-connection developer app key (Twitter Consumer Key; Meta App ID)',
    `app_secret`          VARCHAR(255)   NULL     DEFAULT NULL              COMMENT 'Per-connection developer app secret (Twitter Consumer Secret; Meta App Secret)',
...
CREATE TABLE IF NOT EXISTS `scheduled_posts` (
    ...
    `final_image_filenames` TEXT          NULL     DEFAULT NULL              COMMENT 'JSON array of processed image filenames ready for posting; NULL = text-only post',
...
CREATE TABLE IF NOT EXISTS `post_history` (
    ...
    `image_filenames`       TEXT          NULL     DEFAULT NULL              COMMENT 'JSON array of image filenames at time of posting; NULL = text-only post',
